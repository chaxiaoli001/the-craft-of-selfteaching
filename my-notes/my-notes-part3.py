...
1.2 纵向拆解： “分层拆解” 
分清概念的方法：不断拆解，不断主动整理
每次用图表整理那些概念的时候，就会发现比原来更清晰一些，多次整理，就能谙熟于心
1.3 触类旁通
更多的工作量，其实在于如何才能在脑子里把整个流程拆解清楚，考虑到各个方面

# Part.3.D.indispensable-illusion
1 刚需幻觉
（1）刚需幻觉根源在于：你不会的东西，对你来说感觉上就不是刚需。
（2）不要问学它有什么用，学就是了
（3）花一点力气，真的掌握它，你会有两个 “发现”：你根本离不开它；它其实真没多难
（4）只有真正掌握了那个技能之后，那个技能才会 “变” 成刚需。
（5）要学，想学，那就自顾自去学吧，用不着征求别人的意见！
（6）优势策略
基础策略是，要深刻理解这个现象及其解释：对任何一项技能来说，刚需是自学的结果，而不是自学的原因。
更为重要的一个策略：做个自驱动的人，而非被外部驱动的被动的人。
简单却很有效的策略是三个字：找活干
（7）正确结论：一切的技能都是刚需
真正有意义的判断依据只有一条：有没有时间？

Part.3.E.to-be-thorough
1 全面 —— 自学的境界
（1）全面，是掌握一门手艺的基本
（2）所谓的不混时间，无非就是刻意练习、追求全面
（3）绝对不能只靠一本书
（4）一切的 “学会” 和 “学好” 之间的差异，无非是全面程度的差异。
     “学好” 竟然如此简单：多读几本书。狠一点，就是多读很多本书。
（5）提高对所学知识技能的 “全面程度”：教是最好的学习方法。
（6）策略：尽快开始整理归纳总结。建议：一定要自己动手去做。
（7）可以用这个简单的方法影响下一代：有同学问，你就一定要耐心讲讲 —— 对自己有好处。
...
（4）Github 是地球上最大的有效社交网络，因为用作品社交肯定是最高效的。
（5）自学者的最基本素养：学就学得全面；做就做得完整。
（6）给自己足够长的时间去学；在充足 “预算” 之下耐心地练；不断找活干，以用代练；
     然后，最重要的是，一定要尽快尝试着做出属于自己的完整作品，无论大小。
     只有这样，你才是个值得被交往的人。

# Part.3.G.the-golden-age-and-google
1 这是自学者的黄金时代
（1）有事先问 Google 就成了自学者的必备修养。
（2）能 Google 出答案的问题，就不需要去麻烦别人。
（3）不认真使用 Google，你就错过了整个人类历史上自学者最黄金的时代。
（4）Google很久，没有找到答案的情况。这时候，可能需要想办法 “问人” 了。然而，最靠谱的通常并不见得是 “身边的人”，而是互联网上各种垂直社区里的其他用户
     向人问，也是有学问的 —— 很多人张口就问，结果呢？结果没人理。为什么呢？
https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way/blob/master/README-zh_CN.md#%E5%A3%B0%E6%98%8E
								       								      
# Part.3.H.prevent-focus-drifting
1 避免注意力漂移
（1）好奇心是好东西，而且是必须认真呵护的东西 —— 几乎最重要、最强劲的自学动力，都混合着好奇心出现并持续。
（2）注意力漂移不是能杜绝的现象，但必须在关键时刻有所应对
（3）最本质的策略：把 “全面完整” 放到最高优先级。
（4）笔记本：罗列整理那些为了做到 “全面完整” 而必须优先做的事。
     给了优先级：除了这上面罗列的这些东西之外，在当前时间段，别的都不如它们重要。
（5）一方面，是用全面完整来保持自己对重要事情的关注，另外一方面，还需要提高对抗不相关完美诱惑的能力
（6）注意力漂移： “能力不及格者” 的 “轻重不分”——做事不分轻重
